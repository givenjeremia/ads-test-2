<div class="modal-header">
  ...
  <div class="modal-body">
    ...
    <input type="text" class="form-control" name="nama_kendaraan" value="{{ $data->nama }}" required>
    <label for="" class="col-form-label">Komsumsi Bahan Bakar</label>
    <input type="text" class="form-control" name="komsumsi_bahan_bakar" value="{{ $data->komsumsi }}">
