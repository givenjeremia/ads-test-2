<div class="modal-header">
  ...
  <div class="modal-body">
    ...
    <input type="date" class="form-control" name="tanggal_sewa" id="tanggal_sewa" value="{{ $data->tanggal }}">
    <label  class="col-form-label">Waktu Sewa</label>
    <input type="time" class="form-control" name="waktu_sewa" id="tanggal_sewa" value="{{ $data->waktu }}">
